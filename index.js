...
app.get('/ca/:username', async (req, res) => {
    console.log(req.params.username);
    try {
      const updatedData = data.filter(each=>each.name.split(" ").join("").toLowerCase().includes(req.params.username.split(" ").join("").toLowerCase()))
